...
import com.cgcovid19project.Adapter.CoronaAdapter;
import com.cgcovid19project.Adapter.FAQAdapter;
import com.cgcovid19project.Models.Corona;
import com.cgcovid19project.Models.FAQ;
import com.cgcovid19project.Models.Persons;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Chhattisgarh").getJSONObject("districtData");
