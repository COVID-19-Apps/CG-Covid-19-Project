...
public class Jsons {
    ...
    String home_treatment_images, home_treatment_links, lab_test, donate,
            tweets, faq, epass, corona, cg, cbse, vocational_education, go;

    public Jsons() {
    }

    public Jsons(String home_treatment_images, String home_treatment_links, String lab_test, String donate, String tweets, String faq, String epass, String corona, String cg, String cbse, String vocational_education, String go) {
